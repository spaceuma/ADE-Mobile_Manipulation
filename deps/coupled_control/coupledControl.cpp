...
void coupledControl::modifyMotionCommand(double mMaxSpeed, double maxJW, std::vector<float>& jW, MotionCommand rover_command, MotionCommand& modified_rover_command)
{
