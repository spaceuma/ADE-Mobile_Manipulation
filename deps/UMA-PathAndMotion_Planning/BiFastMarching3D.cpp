...
void BiFastMarching3D::computeTMap(
    const std::vector<std::vector<std::vector<double>>> *costMap3D,
    std::vector<int> goal,
    ...
    std::vector<int> *nodeJoin)
{
    ...
    (*closedMapGoal)[nodeTargetGoal[1]][nodeTargetGoal[0]][nodeTargetGoal[2]]
        = 1;
    (*closedMapStart)[nodeTargetStart[1]][nodeTargetStart[0]]
                     [nodeTargetStart[2]]
        = 1;

    (*TMapGoal)[nodeTargetGoal[1]][nodeTargetGoal[0]][nodeTargetGoal[2]] = 0;
    (*TMapStart)[nodeTargetStart[1]][nodeTargetStart[0]][nodeTargetStart[2]]
        = 0;
    ...
    while ((nbTGoal->size() > 0) || (nbTStart->size() > 0))
    {
        if (nbTGoal->size() > 0)
        {
            ...
            (*closedMapGoal)[nodeTargetGoal[1]][nodeTargetGoal[0]]
                            [nodeTargetGoal[2]]
                = 1;
            updateNode(nodeTargetGoal,
                       costMap3D,
        ...
        if ((*closedMapStart)[nodeTargetGoal[1]][nodeTargetGoal[0]]
                             [nodeTargetGoal[2]]
            == 1)
        {
            double GGoalx, GGoaly, GGoalz, GStartx, GStarty, GStartz;
            computeGradient(
                TMapStart, nodeTargetGoal, &GStartx, &GStarty, &GStartz);
            computeGradient(
                TMapGoal, nodeTargetGoal, &GGoalx, &GGoaly, &GGoalz);
        ...
        if ((*closedMapGoal)[nodeTargetStart[1]][nodeTargetStart[0]]
                            [nodeTargetStart[2]]
            == 1)
        {
            double GGoalx, GGoaly, GGoalz, GStartx, GStarty, GStartz;
            computeGradient(
                TMapStart, nodeTargetStart, &GStartx, &GStarty, &GStartz);
            computeGradient(
                TMapGoal, nodeTargetStart, &GGoalx, &GGoaly, &GGoalz);
...
void BiFastMarching3D::updateNode(
...
double BiFastMarching3D::getEikonal(double Tx,
                                    double Ty,
                                    double Tz,
                                    double cost)
{
...
void BiFastMarching3D::computePathGDM(
...
void BiFastMarching3D::computeGradient(
    const std::vector<std::vector<std::vector<double>>> *TMap,
