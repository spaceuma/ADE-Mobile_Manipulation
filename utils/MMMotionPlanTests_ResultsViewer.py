...
ax1.legend((p1[0],p12[0],s1[0],s12[0]),('Path with Shadowing', 'Path without Shadowing', 'Sample Position', 'Initial Rover Position'))
...
ax2.legend((p2[0],p21[0],s2[0],s21[0]),('Path with Shadowing', 'Path without Shadowing', 'Sample Position', 'Initial Rover Position'))
