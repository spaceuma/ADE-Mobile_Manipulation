...
ax1.set_title('Cost Map Rectified (Rover Facing to Sample)')
ax1.set_facecolor('k')
...
ax1.legend((p1[0],s1[0],s12[0]),('Facing Sample Path', 'Sample Position', 'Initial Rover Position'), loc = 'lower right')
...
#s34 = ax2.plot(path_shadowing_01[-1,0], path_shadowing_01[-1,1], 'oc')
...
ax3.legend((p31[0],s2[0],s21[0]),('Path', 'Sample Position', 'Initial Rover Position'), loc = 'lower right')
