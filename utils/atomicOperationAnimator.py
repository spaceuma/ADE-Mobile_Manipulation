...
fig, ax = plt.subplots()
plt.scatter(range(0,len(armJoints)), armJoints[:, 0], label = 'First joint', s = 17)
plt.scatter(range(0,len(armJoints)), armJoints[:, 1], label = 'Second joint', s = 17)
plt.scatter(range(0,len(armJoints)), armJoints[:, 2], label = 'Third joint', s = 17)
plt.scatter(range(0,len(armJoints)), armJoints[:, 3], label = 'Fourth joint', s = 17)
plt.scatter(range(0,len(armJoints)), armJoints[:, 4], label = 'Fifth joint', s = 17)
plt.scatter(range(0,len(armJoints)), armJoints[:, 5], label = 'Sixth joint', s = 17)
