...
for speed in speeds:
    ...
    approaches = ["End", "Progressive", "Beginning", "Decoupled", "MoveIt"]
    ...
    with open(speed+"_motionPlanResultsLog_moveIt.txt", "r") as file_object:
        file_text = file_object.readlines()
        i = 0
        for line in file_text:
            data = line.split(" ")
    ...
    print(approaches[4]+' '+str(mean_computation_time[4])+' s')
    ...
    print(approaches[4]+' '+str(mean_self_collision_distance[4])+' s')
    ...
    print(approaches[4]+' '+str(mean_total_required_time[4])+' s')
    ...
    print(approaches[4]+' '+str(mean_arm_moving_time[4])+' s')
    ...
    print(approaches[4]+' '+str(mean_base_moving_time[4])+' s')
...
plot7 = ax4.bar(approaches[1:4], mean_total_required_times["x1"][1:4], width, facecolor='palegreen', label='Coupled', edgecolor='cornflowerblue', hatch=r"\\" )
plot6 = ax4.bar(approaches[1:4], mean_base_moving_times["x1"][1]-mean_arm_moving_times["x1"][1], width, edgecolor='cornflowerblue', label='Base', facecolor='cornflowerblue')
...
plot12 = ax4.bar(x[1:4]-width*2.2, mean_total_required_times["x06"][1:4], width, facecolor='palegreen', label='Coupled', edgecolor='cornflowerblue', hatch=r"\\" )
plot13 = ax4.bar(x[1:4]-width*2.2, mean_base_moving_times["x06"][1]-mean_arm_moving_times["x06"][1], width, edgecolor='cornflowerblue', label='Base', facecolor='cornflowerblue')
...
plot16 = ax4.bar(x[1:4]-width*1.1, mean_total_required_times["x08"][1:4], width, facecolor='palegreen', label='Coupled', edgecolor='cornflowerblue', hatch=r"\\" )
plot17 = ax4.bar(x[1:4]-width*1.1, mean_base_moving_times["x06"][1]-mean_arm_moving_times["x08"][1], width, edgecolor='cornflowerblue', label='Base', facecolor='cornflowerblue')
...
plot20 = ax4.bar(x[1:4]+width*1.1, mean_total_required_times["x12"][1:4], width, facecolor='palegreen', label='Coupled', edgecolor='cornflowerblue', hatch=r"\\" )
plot21 = ax4.bar(x[1:4]+width*1.1, mean_base_moving_times["x12"][1]-mean_arm_moving_times["x12"][1], width, edgecolor='cornflowerblue', label='Base', facecolor='cornflowerblue')
...
plot24 = ax4.bar(x[1:4]+width*2.2, mean_total_required_times["x14"][1:4], width, facecolor='palegreen', label='Coupled', edgecolor='cornflowerblue', hatch=r"\\" )
plot25 = ax4.bar(x[1:4]+width*2.2, mean_base_moving_times["x14"][1]-mean_arm_moving_times["x14"][1], width, edgecolor='cornflowerblue', label='Base', facecolor='cornflowerblue')
...
plot28 = ax4.bar(x[1:4]-width*3.3, mean_total_required_times["x04"][1:4], width, facecolor='palegreen', label='Coupled', edgecolor='cornflowerblue', hatch=r"\\" )
plot29 = ax4.bar(x[1:4]-width*3.3, mean_base_moving_times["x04"][1]-mean_arm_moving_times["x04"][1], width, edgecolor='cornflowerblue', label='Base', facecolor='cornflowerblue')
...
plot32 = ax4.bar(x[1:4]-width*4.4, mean_total_required_times["x02"][1:4], width, facecolor='palegreen', label='Coupled', edgecolor='cornflowerblue', hatch=r"\\" )
plot33 = ax4.bar(x[1:4]-width*4.4, mean_base_moving_times["x02"][1]-mean_arm_moving_times["x02"][1], width, edgecolor='cornflowerblue', label='Base', facecolor='cornflowerblue')

plot34 = ax4.bar(approaches[4], mean_total_required_times["x1"][4], width, facecolor='palegreen', label='Coupled', edgecolor='cornflowerblue', hatch=r"\\" )
plot35 = ax4.bar(approaches[4], mean_base_moving_times["x1"][4]-mean_arm_moving_times["x1"][4], width, edgecolor='cornflowerblue', label='Base', facecolor='cornflowerblue')
plot36 = ax4.bar(x[4]-width*2.2, mean_total_required_times["x06"][4], width, facecolor='palegreen', label='Coupled', edgecolor='cornflowerblue', hatch=r"\\" )
plot37 = ax4.bar(x[4]-width*2.2, mean_base_moving_times["x06"][4]-mean_arm_moving_times["x06"][4], width, edgecolor='cornflowerblue', label='Base', facecolor='cornflowerblue')
plot38 = ax4.bar(x[4]-width*1.1, mean_total_required_times["x08"][4], width, facecolor='palegreen', label='Coupled', edgecolor='cornflowerblue', hatch=r"\\" )
plot39 = ax4.bar(x[4]-width*1.1, mean_base_moving_times["x06"][4]-mean_arm_moving_times["x08"][4], width, edgecolor='cornflowerblue', label='Base', facecolor='cornflowerblue')
plot40 = ax4.bar(x[4]+width*1.1, mean_total_required_times["x12"][4], width, facecolor='palegreen', label='Coupled', edgecolor='cornflowerblue', hatch=r"\\" )
plot41 = ax4.bar(x[4]+width*1.1, mean_base_moving_times["x12"][4]-mean_arm_moving_times["x12"][4], width, edgecolor='cornflowerblue', label='Base', facecolor='cornflowerblue')
plot42 = ax4.bar(x[4]+width*2.2, mean_total_required_times["x14"][4], width, facecolor='palegreen', label='Coupled', edgecolor='cornflowerblue', hatch=r"\\" )
plot43 = ax4.bar(x[4]+width*2.2, mean_base_moving_times["x14"][4]-mean_arm_moving_times["x14"][4], width, edgecolor='cornflowerblue', label='Base', facecolor='cornflowerblue')
plot44 = ax4.bar(x[4]-width*3.3, mean_total_required_times["x04"][4], width, facecolor='palegreen', label='Coupled', edgecolor='cornflowerblue', hatch=r"\\" )
plot45 = ax4.bar(x[4]-width*3.3, mean_base_moving_times["x04"][4]-mean_arm_moving_times["x04"][4], width, edgecolor='cornflowerblue', label='Base', facecolor='cornflowerblue')
plot46 = ax4.bar(x[4]-width*4.4, mean_total_required_times["x02"][4], width, facecolor='palegreen', label='Coupled', edgecolor='cornflowerblue', hatch=r"\\" )
plot47 = ax4.bar(x[4]-width*4.4, mean_base_moving_times["x02"][4]-mean_arm_moving_times["x02"][4], width, edgecolor='cornflowerblue', label='Base', facecolor='cornflowerblue')
...
ax4.text(x[4]-width*4.9, mean_total_required_times["x02"][4]+1, "x0.2", fontsize=12)
...
ax4.text(x[4]-width*3.8, mean_total_required_times["x04"][4]+1, "x0.4", fontsize=12)
...
ax4.text(x[4]-width*2.75, mean_total_required_times["x06"][4]+1, "x0.6", fontsize=12)
...
ax4.text(x[4]-width*1.6, mean_total_required_times["x08"][4]+1, "x0.8", fontsize=12)
...
ax4.text(x[4]-width*0.2, mean_total_required_times["x1"][4]+1, "x1", fontsize=12)
...
ax4.text(x[4]+width*0.6, mean_total_required_times["x12"][4]+1, "x1.2", fontsize=12)
...
ax4.text(x[4]+width*1.75, mean_total_required_times["x14"][4]+1, "x1.4", fontsize=12)
