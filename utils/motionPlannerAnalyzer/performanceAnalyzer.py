...
plot3 = ax2.errorbar(approaches, mean_avg_self_collision_distance, std_dev_avg_self_collision_distance, linestyle='None', marker='o', capsize = 5)
...
plot5 = ax3.errorbar(approaches, mean_proportional_total_time, std_dev_proportional_total_time, linestyle='None', marker='^', capsize = 5)
ax3.set_ylabel('Proportion of motion execution time w.r.t. DECOUPLED solution')
ax3.set_ylim(bottom = 0)
ax3.grid()

fig4, ax4 = plt.subplots()
plot6 = ax4.errorbar(approaches, mean_arm_moving_time, linestyle='None', marker='o', capsize = 5)
plot7 = ax4.errorbar(approaches, mean_base_moving_time, linestyle='None', marker='x', capsize = 5)
plot8 = ax4.errorbar(approaches, mean_total_required_time, linestyle='None', marker='^', capsize = 5)
