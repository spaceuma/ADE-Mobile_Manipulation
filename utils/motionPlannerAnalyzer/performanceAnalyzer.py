...
plot1 = ax1.errorbar(approaches, mean_computation_time, std_dev_computation_time, linestyle='None', ecolor= 'black', marker='s', mfc='y', mec = 'black', capsize = 5)
ax1.set_ylabel('Computation time (s)')
ax1.set_ylim(bottom = 0)
ax1.grid()

fig2, ax2 = plt.subplots()
plot2 = ax2.errorbar(approaches, mean_min_self_collision_distance, std_dev_min_self_collision_distance, linestyle='None', ecolor= 'black', marker='s', mfc='b', mec = 'black', capsize = 5)
plot3 = ax2.errorbar(approaches, mean_avg_self_collision_distance, std_dev_avg_self_collision_distance, linestyle='None', ecolor= 'black', marker='s', mfc='y', mec = 'black', capsize = 5)
plot4 = ax2.errorbar(approaches, mean_max_self_collision_distance, std_dev_max_self_collision_distance, linestyle='None', ecolor= 'black', marker='s', mfc='r', mec = 'black', capsize = 5)
...
plot5 = ax3.errorbar(approaches, mean_proportional_total_time, std_dev_proportional_total_time, linestyle='None',  ecolor= 'black', marker='s', mfc='y', mec = 'black', capsize = 5)
ax3.set_ylabel('Proportion of motion execution time w.r.t. DECOUPLED solution')
ax3.set_ylim(bottom = 0)
ax3.grid()

fig4, ax4 = plt.subplots()
plot6 = ax4.errorbar(approaches, mean_arm_moving_time, linestyle='None', marker='s', mec = 'black', capsize = 5)
plot7 = ax4.errorbar(approaches, mean_base_moving_time, linestyle='None', marker='o', mec = 'black', capsize = 5)
plot8 = ax4.errorbar(approaches, mean_total_required_time, linestyle='None', marker='x', mec = 'black', capsize = 5)
