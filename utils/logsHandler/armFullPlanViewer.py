...
#path3D[:,2] = path3D[:,2]-offset[2]+path[0,2]
...
mlab.surf(yMap,xMap, np.flipud(np.rot90(DEM0)), color = (193/255,68/255,14/255)) #np.flipud(np.fliplr(DEM0)))
...
mlab.points3d(path[-1][0], path[-1][1], DEM0[int(path[-1][0]/res+0.5),int(path[-1][1]/res+0.5)], scale_factor = 0.2, color=(192/255,192/255,192/255))
