...
s3 = ax.plot(sample[0], sample[1], 'og')
...
ax.legend((c1, p1[0],p2[0],p3[0],s3[0]),('Corridor Area', 'Computed Path',\
        'Rover Groundtruth Positions', 'Rover Localization Positions', 'Sample Pos'), loc = 'lower right')
