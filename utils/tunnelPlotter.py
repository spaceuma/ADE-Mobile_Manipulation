...
mlab.quiver3d(np.array([5, 5, 5]), np.array([30, 30, 30]), np.array([10+6.25, 10+6.25, 10+6.25]), np.array([1, 0, 0]), np.array([0, 1, 0]), np.array([0, 0, 1]), scale_factor = 20, color = (0,1,0))
mlab.quiver3d(np.array([91.4, 91.4, 91.4]), np.array([66.7, 66.7, 66.7]), np.array([12,12,12]), np.array([1, 0, 0]), np.array([0, 1, 0]), np.array([0, 0, 1]), scale_factor = 20, color = (0,1,0))
mlab.quiver3d(np.array([94, 94, 94]), np.array([65.1, 65.1, 65.1]), np.array([12,12,12]), np.array([1, 0, 0]), np.array([0, 1, 0]), np.array([0, 0, 1]), scale_factor = 20, color = (0,1,0))
